...
export default class Home extends React.Component {
	...
	submitHandler = (e) => {
		...
		axios
			.post("https://contact-nodeberry.herokuapp.com/contacts/nf_labs/subscribe", {
			...
			<div>
				...
				<div className="jumbotron-wrapper">
					<div className="jumbotron container">
						<div>
							<h1>
								Create, test, <span style={{ color: "var(--orange)" }}>innovate, </span> repeat
							</h1>
							<p>
								The future is here. We innovate immense solutions for the enhancement of blockchain
				...
				<div className="section-wrapper">
					<div className="section-1 container">
						...
						<div>
							<h2>Turning The Impossible Possible</h2>
							<p>
								...
								<span style={{ color: "var(--orange)" }}>
									{" "}
									The technology is still rarely used for real-world applications.{" "}
								</span>
								We're destined to create applications that can enhance the adoption of blockchain in
								various industries as a technology that can transform their exisiting business
								practices.
							</p>
						</div>
					</div>
				...
				<div id="mission" className="section-wrapper">
					<div className="section-1 container">
						...
						<div>
							<h2>Freedom is Our Mission</h2>
							<p>
								We Create Products for Real-life use cases. We're connected to our users by
								experience & heart. Actions speak more than words & hence our product will speak
								more about us. <br /> <br />
								<span style={{ color: "var(--orange)" }}>
									{" "}
									We touch and convert everything decentralized. We hate centralized ownership &
									censorship in all ways.{" "}
								</span>
							</p>
						</div>
					</div>
				...
				<div className="newsletter container">
					<h2>Get it first.</h2>
					<p>Stay ahead of the curve and sign up for the latest news and updates from NF Labs.</p>
					<div>

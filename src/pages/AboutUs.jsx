        ...
        return(
            <div>
                ...
                <section className="container about-sec">
                    <div className="main-content">
                        <div className="about">
                            ...
                            <p className="about-desc">Adopting Blockchain ? Don’t lose your momentum. <br/> Keep up with the current trends of the market & establish esteemed products that are not mere clones of uniswap or other popular Dapps.</p>
                        </div>
                        <div className="approach">
                            <h1 className="about-heading">Our Approach</h1>
                            <p className="about-desc">We don’t reinvent the wheel. We discover a better & optimized way of using it. NF Labs research is heavily based on the optimal utilization of existing public blockchain to get more out of them. 
                                <br/><br/>
                                “We don’t make promises, but we deliver promises.“</p>
                        </div>
                    </div>
                ...
                <section className="team">
                    ...
                    <p className="container team-desc">We’re here and we’ll be here with the same motive of improving the blockchain world for a better & efficient future.</p>
                        <Slick />
                </section>
                <section className="container join">
                    <h1>What Are You Waiting For ?</h1>
                    <p>Want us to join your R & D Team ? You’re just one-step away from a resourceful collaboration.</p>
